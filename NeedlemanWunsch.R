# Script para realizar un pairwise global alignment usando el algoritmo
# Needleman-Wunsch

setwd("~/Documents/Bioinformatica-Salud/PGB/Semana_1/Practica_1/")
...
TraceBackFunction <- function(rowSeq, colSeq, DirectM, AlignM){
  ...
  tracingWhile <- function(rowSeq,colSeq,DirectM,AlignM, alignRow, alignCol, i = length(rowSeq) ,j = length(colSeq)){
    ...
    print(paste("Alineamiento nº ", seqs, " :"))
